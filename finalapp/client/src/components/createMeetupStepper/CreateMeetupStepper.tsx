...
import { RequiredCreateForm, FormRequiredData } from '../forms/create/required/RequiredCreateForm'
import { FormAdditionalData, AdditionalCreateForm } from '../forms/create/additional/AdditionalCreateForm'
...
export const CreateMeetupStepper = (props: CreateMeetupStepperProps): JSX.Element => {
    ...
    const [additionalFormData, setAdditionalFormData] = React.useState<FormAdditionalData | null>(null)
