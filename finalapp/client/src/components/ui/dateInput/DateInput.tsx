...
export const DateInput = (props: DateInputProps): JSX.Element => {
    ...
    const getStringDate = (year: number, month: number, day?: number, hours?: number, minutes?: number): string => {
        let newValue = ''
    ...
    const onDatePick = (year: number, month: number, day?: number, hours?: number, minutes?: number) => {
